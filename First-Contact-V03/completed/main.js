 ...
 * ng-transclude: true --> <p ng-transclude> isLoading...</p>
 * <muj-spinner> <span> Mooing </span> </muj-spinner>
 */
app.directive('ccSpinner', function () {
	return {
		...
		'scope': {
			//I want to have a isLoading in my scope which linked into outer scope
			//<muj-spinner is-loading="contact.isLoading"> </muj-spinner>
			'isLoading': '=',
			'message': '@'
		}
	}
